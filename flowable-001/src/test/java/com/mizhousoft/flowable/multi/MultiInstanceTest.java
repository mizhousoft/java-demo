package com.mizhousoft.flowable.multi;
...
import com.mizhousoft.flowable.workflow.TaskData;
...
public class MultiInstanceTest
{
	...
	public void deploy()
	{
		repositoryService.createDeployment().addClasspathResource("bpmn/multi-instance.bpmn20.xml").deploy();
	}
	...
	public void start()
	{
		...
		map.put("day", 3);
		map.put("countersignAssigneeList", List.of("a1", "a2"));

		runtimeService.startProcessInstanceByKey("approve-multi", "test", map);
	}
