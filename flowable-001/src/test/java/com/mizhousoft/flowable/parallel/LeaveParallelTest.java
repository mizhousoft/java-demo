package com.mizhousoft.flowable.parallel;
...
public class LeaveParallelTest
{
	@Autowired
	...
	public void deploy()
	{
		repositoryService.createDeployment().addClasspathResource("bpmn/leave-parallel.bpmn20.xml").deploy();
	}
	...
	public void start()
	{
		...
		runtimeService.startProcessInstanceByKey("leave-parallel", "test", map);
	}
